            ...
            children: [
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Text('Quantity: ${item.quantity_inandiar}, Total: \$${item.totalPrice_inandiar}'), // Subtitle qty dan total
                      trailing: IconButton(
                        icon: Icon(Icons.remove_inandiar),
                        onPressed: () {
                          cart.removeFromCart_inandiar(item.product_inandiar.id_inandiar);
                        },
                      ),
                    );
                  },
              ...
              Padding(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(labelText: 'Enter NIM_inandiar'), // Input NIM
                ),
              ),
              Padding(
                padding: const EdgeInsets.all(16.0),
                child: Text('Total: \$${cart.totalPrice_inandiar}'), // Tampilkan total
              ),
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  if (nim_inandiar.isNotEmpty) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Checkout successful!'))); // Snackbar sukses
                  } else {
                    print('NIM kosong, gak bisa checkout'); // Debug kalau NIM kosong
                  }
                },
              ),
            ],
