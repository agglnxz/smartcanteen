...
import 'cart_screen_inandiar.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.shopping_cart), // Icon cart
            onPressed: () {
              Navigator.push(
                context,
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          List<Product_inandiar> products_inandiar = snapshot.data!.docs
              .map((doc) => Product_inandiar.fromFirestore(doc))
              .toList();
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                subtitle: Text(
                  'Price: \$${product_inandiar.price_inandiar}, Stock: ${product_inandiar.stock_inandiar}',
                ), // Subtitle harga dan stok
                trailing: ElevatedButton(
                  child: Text('Add to Cart_inandiar'),
                  onPressed: () {
                    Provider.of<CartProvider_inandiar>(
                      context,
                      listen: false,
                    ).addToCart_inandiar(product_inandiar);
                  },
                ),
              );
            },
